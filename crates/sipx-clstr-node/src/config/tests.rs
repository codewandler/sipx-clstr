...
// -------------------------------------------------------- roles, and what they wire (§4, FC-6) ---
...
/// to `DP-8` until `FC-6`, which is when there was a wiring to compare it against.
#[test]
...
/// **`FC-6`.** A role wires a path; the roles that wire neither do not silently acquire one.
///
...
#[test]
fn fc6_capabilities_are_the_union_of_what_the_roles_wire() {
