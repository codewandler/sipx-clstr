...
- [AF-4 — Implement the token mint/verify library](AF-4-implement-the-token-mint-verify-library.md) · Cluster · all 18 AT vectors proved; sans-IO verified by dependency graph, and CX-5's nonce class closed
