...
- [CX-5 — File the nonce-uniqueness defect upstream and make nonce uniqueness normative](CX-5-file-the-nonce-uniqueness-defect-upstream.md) · Platform · the nonce is a function of the clock alone, so honest users collide in the replay window
