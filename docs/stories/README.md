...
- [DX-12 — Gate that every site page is reachable and every command shown is real](DX-12-gate-that-every-page-is-reachable-and-real.md) · Foundation · supersedes the site half of CF-11 — after the split no spec is published, so the concern moved
