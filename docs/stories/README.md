...
- [PX-13 — Route ACK and in-dialog requests by the Route set, not by an address-of-record lookup](PX-13-route-ack-and-in-dialog-requests-by-route-set.md) · Signalling · reverted on a bad threshold, not a leak — it drains at 128·T1, which RFC 3261 permits; blocked on CF-22 correcting the window
