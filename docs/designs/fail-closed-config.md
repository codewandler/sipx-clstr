...
### FC-6, added after the fact: the same rule applied to `roles`

`FC-6` was not one of the four. It joined this epic because the independent review of `v0.12.0` found
