...
**134 of 581 rows proved**; 19 covered for shape only; 428 deferred.

Σ over the 61 sections below is 581, so every row counted above is shown in exactly one table.
