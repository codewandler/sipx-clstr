...
One row per vector in [proxy-behavior](../specs/proxy-behavior.md) §12, [e2e-probe](../specs/e2e-probe.md) §10, [registrar-auth](../specs/registrar-auth.md) §8 and [hook-framework](../specs/hook-framework.md) §9.
...
**77 of 98 rows proved**; 21 deferred.
